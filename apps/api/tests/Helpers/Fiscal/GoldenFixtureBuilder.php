...
final class GoldenFixtureBuilder
{
    ...
    public static function all(): array
    {
        return [
            ...
            // F-16 is event_version=4 (v3-refund-chain-integration spec §17);
            // F-15 (large-receipt, generated by LargeReceiptFixtureGenerator,
            // not this builder) intentionally has no slot in this list.
            'F-16-refund-v4-cash-eur' => self::f16RefundV4Cash(),
        ];
    }

    /**
     * v4 REFUND — spec `2026-07-31-v3-refund-chain-integration.md` §3, §17
     * fixture F-16. event_version=4: the v3 cash-rounding siblings PLUS the
     * three v4-only keys (`original_line_references`, `refund_destination`,
     * `settlement_allocation`). Single cash-only refund of F-01's original
     * line, restocked.
     *
     * @return array<string, mixed>
     */
    private static function f16RefundV4Cash(): array
    {
        return self::baseEnvelope([
            'receipt_uuid' => '00000000-0000-4000-8000-000000000016',
