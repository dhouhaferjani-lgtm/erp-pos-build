...
final class CsvStatementParserTest extends TestCase
{
    ...
    public function test_csv_parses_preamble_semicolon_dates_locale_amounts_and_reports_dropped_rows(): void
    {
        ...
        $this->assertSame('1234.56', $result->lines[0]->amount);
    ...
    public function test_locale_decimal_thousands_trap_and_identical_occurrences_get_distinct_fingerprints(): void
    {
        ...
        $this->assertSame('7140', $result->lines[0]->amount, '7.140 is a thousands trap under comma-decimal format.');
        $this->assertSame('7140', $result->lines[1]->amount);
    ...
    public function test_xlsx_parses_excel_serial_dates_and_formula_values_but_reports_formula_errors(): void
    {
        ...
        $sheet->setCellValue('B5', '=1/0');
        $sheet->setCellValue('C5', 'XLSX-BAD');
        $sheet->setCellValue('D5', 'Broken formula');
        ...
        $this->assertSame('120', $result->lines[0]->amount);
        $this->assertSame([['row' => 5, 'reason' => 'Formula could not be evaluated in cell B5']], $result->unparseableRows);
