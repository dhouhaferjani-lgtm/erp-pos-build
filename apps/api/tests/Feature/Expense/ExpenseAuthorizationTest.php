...
final class ExpenseAuthorizationTest extends TestCase
{
    use RefreshDatabase;

    public function test_list_expenses_requires_expenses_view(): void
    {
        [$user, $company] = $this->makeUserWithPermissions([]); // no perms
    ...
    {
        [$user, $company] = $this->makeUserWithPermissions(['expenses.view']); // view but not create
        app(CompanyContext::class)->setCompanyId($company->id);
        $this->actingAs($user, 'sanctum')
