...
final class TransferReceiptSecondOfEverythingTest extends TransferReceiptFeatureTestCase
{
    public function test_full_transfer_entity_types_are_generated(): void
    {
        ...
        self::assertSame([], array_values(array_filter(['StockTransferData', 'StockTransferLineData', 'StockTransferLineBatchAllocationData'], static fn (string $name): bool => ! str_contains($generated, 'interface '.$name))));
    }
