 ...
 *
 * The six Workshop tests that ran red against T25b
 * (`DocumentGenerationAdapterStripsSubToleranceDiscountTest`,
 * `DocumentLineWorkOrderLineIdRetentionTest`,
 * `DocumentGenerationAdapterDesignationTest`) are the end-to-end half of the same
 * evidence and must be green.
 */
