...
/**
 * Event raised when a member is downgraded to a lower loyalty tier.
 *
 * This operational event captures tier regression when a member fails to maintain
 * the qualification criteria for their current tier, typically during tier review periods.
 *
 * IMPORTANT: This event is immutable. Never rename or change its structure.
 * If requirements change, create TierDowngradedV2.
 */
final class TierDowngraded extends DomainEvent
{
    ...
    {
        return 'loyalty.tier.downgraded';
    }
