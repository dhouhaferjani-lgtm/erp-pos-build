...
final class DocumentLineData extends Data
{
    public function __construct(
        ...
        public string $free_quantity_received,
    ...
    public static function fromModel(DocumentLine $line, int $scale = 3): self
    {
        return new self(
            ...
            quantity_received: QuantityScale::formatForUnit($line->quantity_received ?? '0', null),
            free_quantity_received: QuantityScale::formatForUnit($line->free_quantity_received ?? '0', null),
