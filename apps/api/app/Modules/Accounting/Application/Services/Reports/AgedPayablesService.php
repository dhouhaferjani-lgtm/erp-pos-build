...
final readonly class AgedPayablesService
{
    ...
    {
        $postedPurchaseOrders = Document::query()
        ...
        $autoReceivedPurchaseOrders = $this->autoGeneratedReceivedPurchaseOrdersWithAccrual($companyId, $asOfDate);
     ...
     * @return Collection<int, Document>
     */
    private function autoGeneratedReceivedPurchaseOrdersWithAccrual(string $companyId, Carbon $asOfDate): Collection
    {
        /** @var Company $company */
        ...
        $purchaseOrders = Document::query()
            ...
            ->with(['partner:id,name,type', 'lines'])
            ->get();
