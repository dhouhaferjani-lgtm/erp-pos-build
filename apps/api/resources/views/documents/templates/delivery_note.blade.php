...
@section('content')
    ...
    <div style="margin-bottom: 20px; font-size: 9pt;">
        <strong>{{ __('Order Reference') }}:</strong> {{ $document->reference }}
    </div>
    @endif
    ...
    <table class="items-table">
        <thead>
            <tr>
                ...
                <th class="center" style="width: 15%;">{{ __('Ordered') }}</th>
                <th class="center" style="width: 15%;">{{ __('Delivered') }}</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="center">{{ $formatNumber($line->quantity_delivered ?? $line->quantity, 2) }}</td>
    ...
    <div style="margin-top: 40px; display: table; width: 100%;">
        <div style="display: table-cell; width: 48%; padding-right: 4%;">
            <div style="font-size: 9pt; color: #666; margin-bottom: 10px;">{{ __('Delivered By') }}:</div>
