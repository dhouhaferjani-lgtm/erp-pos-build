...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    private function createRoles(): void
    {
        ...
        $manager->syncPermissions([
            ...
            'instruments.view', 'instruments.create', 'instruments.update', 'instruments.transfer', 'instruments.clear', 'instruments.bounce', 'instruments.remit',
            'repositories.view',
        ...
        $accountant->syncPermissions([
            ...
            'payments.view', 'payments.create', 'payments.allocate', 'payments.refund',
            'instruments.view', 'instruments.update', 'instruments.transfer', 'instruments.clear', 'instruments.bounce', 'instruments.remit',
