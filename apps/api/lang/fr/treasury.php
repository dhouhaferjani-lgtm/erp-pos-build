...
return [
    ...
    'allocation_refused' => [
        ...
        'historical_opening_provenance' => "Ce solde d'ouverture est un avoir, ou son sens (client ou fournisseur) n'a pas pu être déterminé à partir de l'import qui l'a créé. Il ne peut pas encore être réglé : corrigez-le par une correction de solde d'ouverture, ou contactez le support.",
