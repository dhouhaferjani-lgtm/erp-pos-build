...
return [
    ...
    */
    ...
    'dates' => [
        'due_date_before_document_date' => "La date d'échéance ne peut pas précéder la date du document (:document_date).",
        'valid_until_before_document_date' => 'La date de validité ne peut pas précéder la date du document (:document_date).',
    ],
    'bonus_quantity' => [
