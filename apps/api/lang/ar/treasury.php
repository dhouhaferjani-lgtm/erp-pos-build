...
return [
    ...
    'allocation_refused' => [
        ...
        'historical_opening_provenance' => 'هذا رصيد افتتاحي لمورّد، أو رصيد افتتاحي تعذّر تحديد جهته. لا يمكن تسوية الأرصدة الافتتاحية للموردين بعد — سيتوفّر دفعها في إصدار لاحق.',
