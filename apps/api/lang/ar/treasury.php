...
return [
    ...
    /*
     * F-W2-13 (P0) — سبب رفض الردّ في مسار ردّ مبالغ العملاء.
     * يُعرض كـ `message` ضمن 422 `REFUND_LANE_REFUSED`، ويرافقه نوع الدفعة في
     * `details.payment_type`.
     */
    'refund_refused' => [
        'supplier_payment' => 'تمت هذه الدفعة على فاتورة مورّد، لذا لا يمكن ردّها من هنا: هذه الشاشة تردّ الأموال المحصّلة من العملاء، بينما خرج هذا المبلغ إلى مورّد. التراجع عن دفعة فاتورة مورّد يخصّ مسار دفع المورّدين وهو غير متاح بعد — يرجى التواصل مع المسؤول.',
    ],
];
