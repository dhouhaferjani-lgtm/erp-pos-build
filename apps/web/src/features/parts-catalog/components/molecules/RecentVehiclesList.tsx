      ...
      {vehicleHistory.length === 0 ? (
        ...
        <div className="space-y-1">
          {vehicleHistory.map((vehicle) => (
            ...
            >
              <div className={`flex items-center justify-center h-8 w-8 rounded-md ${colorTokens.surface.muted} ${colorTokens.intent.primary.groupBgHover} transition-colors shrink-0`}>
