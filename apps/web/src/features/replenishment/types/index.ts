...
export interface ReplenishmentHistoryResponse { data: ReplenishmentLine[]; meta: OffsetPaginationMeta }
export interface ReplenishmentListFilters { status?: 'open' | ReplenishmentStatus; location_ids?: string[]; product_id?: string; from?: string; to?: string; page?: number; per_page?: number }
