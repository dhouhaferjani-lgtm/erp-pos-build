...
const buttonPrimary =
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-ctl bg-action px-4 font-semibold text-ink-inverse transition-colors ' +
...
const buttonConfirm =
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-ctl bg-success px-4 font-semibold text-ink-inverse transition-colors ' +
  'hover:bg-success-hover ' +
  'disabled:cursor-not-allowed disabled:bg-surface-sunken disabled:text-ink-faint';

/** Secondary / neutral action. */
const buttonSecondary =
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-ctl border border-border-subtle bg-surface-raised px-4 font-medium text-ink transition-colors ' +
...
const buttonGhost =
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-ctl px-3 font-medium text-ink transition-colors ' +
...
const buttonDestructive =
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-ctl bg-danger px-4 font-semibold text-ink-inverse transition-colors ' +
  'hover:opacity-90 ' +
  'disabled:cursor-not-allowed disabled:bg-surface-sunken disabled:text-ink-faint';
...
export const tokens = {
  ...
  badge: {
    neutral:
      'inline-flex items-center gap-1 rounded-pill border border-border-subtle bg-surface-sunken px-2 py-0.5 text-xs font-medium text-ink-muted',
    success:
      'inline-flex items-center gap-1 rounded-pill border border-success-subtle bg-success-surface px-2 py-0.5 text-xs font-medium text-success-strong',
    warning:
      'inline-flex items-center gap-1 rounded-pill border border-warning-subtle bg-warning-surface px-2 py-0.5 text-xs font-medium text-warning-strong',
    danger:
      'inline-flex items-center gap-1 rounded-pill border border-danger-subtle bg-danger-surface px-2 py-0.5 text-xs font-medium text-danger-strong',
  },

  /** The ONE segmented (choose-one) control voice. */
  segmented: {
    root: 'inline-flex rounded-ctl bg-surface-sunken p-1',
    item: 'flex min-h-12 items-center justify-center rounded-sm px-3 text-sm font-medium transition-colors',
  ...
  statusPill: {
    base: 'inline-flex items-center gap-2 rounded-pill px-3 py-1 text-sm font-medium',
