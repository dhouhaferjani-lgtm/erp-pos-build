...
- Fresh live Playwright smoke: 6/6 passed in 26.2s against the db-per-tenant stack, including Tier 3 cleared state, Tier 4 fee provenance and movement amount/direction, checkpoint balance semantics, and rejected same-date writes.
- Fresh `treasury:reconcile --tenant=019f2313-4ff7-73aa-99fd-fc6fbbedcce4`: checked 9 repositories; froze 0; 0 portfolio drifts; 0 statement alerts; 0 errors.
