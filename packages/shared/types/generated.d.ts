...
export type TransferReceiptFailureReason = 'OVER_RECEIPT' | 'LOT_OVER_RECEIPT' | 'UNKNOWN_LOT' | 'LOT_REQUIRED' | 'LOT_NOT_ALLOWED' | 'LOT_SUM_MISMATCH' | 'LOT_TRACKING_MISMATCH' | 'LINE_NOT_ON_TRANSFER' | 'NOTHING_TO_RECEIVE' | 'DISCREPANCY_REASON_REQUIRED' | 'DISCREPANCY_REASON_INVALID' | 'IDEMPOTENCY_KEY_REUSED' | 'DISPOSITION_REQUIRED' | 'BLIND_REQUIRES_COUNTED_RECEIPT' | 'VALUATION_MODE_UNSUPPORTED';
