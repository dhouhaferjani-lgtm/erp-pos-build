...
export type CashMovementSourceType = 'customer_payment' | 'payment' | 'pos_receipt' | 'pos_receipt_refund' | 'supplier_payment';
}
...
export type GlResidualRefusal = 'negative_residual' | 'no_absorbing_account' | 'residual_exceeds_rounding_tolerance' | 'legs_do_not_balance' | 'no_credit_note_stamp_account' | 'lineless_document_unpostable';
...
invoiced_by_document_id: string | null;
invoiced_by_document_number: string | null;
...
payments: Array<any>;
proforma: App.Modules.Document.Application.DTOs.ProformaPresentationData | null;
created_at: string;
updated_at: string;
};
...
export type ProformaLineAmounts = {
line_id: string;
unit_price: string;
line_total: string;
};
export type ProformaPresentationData = {
estimated_total: string;
gross_lines: string;
stamp_duty: string | null;
discount: string | null;
adjustment: string | null;
lines: Array<App.Modules.Document.Application.DTOs.ProformaLineAmounts>;
};
...
export type DeliveryComplianceCode = 'COMPLIANT' | 'NO_DELIVERY_NOTES' | 'DRAFT_DELIVERY_NOTES' | 'INCOMPLETE_DELIVERY' | 'DELIVERY_REQUIRED_BEFORE_INVOICE';
...
export type ImportCorrectionData = {
...
transfer_type: App.Modules.Inventory.Domain.Enums.TransferType;
status: App.Modules.Inventory.Domain.Enums.TransferStatus;
...
transfer_cost_distribution: App.Modules.Inventory.Domain.Enums.TransferCostDistribution;
...
close_disposition: App.Modules.Inventory.Domain.Enums.TransferCloseDisposition | null;
close_reason: App.Modules.Inventory.Domain.Enums.TransferDiscrepancyReason | null;
close_note: string | null;
freight_uncapitalized: string;
receipts: Array<App.Modules.Inventory.Application.DTOs.TransferReconciliationReceiptData>;
lines: Array<App.Modules.Inventory.Application.DTOs.StockTransferLineData> | null;
};
export type StockTransferLineBatchAllocationData = {
id: string;
batch_id: number;
batch_number: string;
...
quantity_written_off: string;
quantity_returned: string;
quantity_remaining: string;
};
export type StockTransferLineData = {
id: string;
product_id: string;
product_name: string | null;
product_sku: string | null;
...
quantity_returned: string;
quantity_remaining: string;
batch_allocations: Array<App.Modules.Inventory.Application.DTOs.StockTransferLineBatchAllocationData>;
};
export type StockTransferReceiptData = {
id: string;
receipt_number: string;
kind: App.Modules.Inventory.Domain.Enums.TransferReceiptKind;
sequence: number;
status: App.Modules.Inventory.Domain.Enums.TransferReceiptStatus;
is_blind: boolean;
has_discrepancy: boolean;
received_by: { id: string; name: string };
received_at: string;
notes: string | null;
lines: Array<App.Modules.Inventory.Application.DTOs.StockTransferReceiptLineData>;
};
export type StockTransferReceiptLineData = {
id: string;
...
quantity_received: string;
quantity_damaged: string;
discrepancy_reason: App.Modules.Inventory.Domain.Enums.TransferDiscrepancyReason | null;
discrepancy_note: string | null;
lots: Array<App.Modules.Inventory.Application.DTOs.StockTransferReceiptLineLotData>;
};
export type StockTransferReceiptLineLotData = {
batch_id: string;
batch_number: string;
quantity_received: string;
quantity_damaged: string;
};
export type TransferCloseLineData = {
id: string;
transfer_line_id: string;
product_id: string;
variant_id: string | null;
is_lot_tracked: boolean;
quantity_sent_snapshot: string;
quantity_received: string;
quantity_damaged: string;
quantity_written_off: string;
quantity_returned: string;
discrepancy_reason: App.Modules.Inventory.Domain.Enums.TransferDiscrepancyReason | null;
discrepancy_note: string | null;
lots: Array<App.Modules.Inventory.Application.DTOs.TransferCloseLineLotData>;
};
export type TransferCloseLineLotData = {
batch_id: string;
batch_number: string;
quantity_received: string;
quantity_damaged: string;
...
export type TransferCloseReceiptData = {
id: string;
receipt_number: string;
kind: App.Modules.Inventory.Domain.Enums.TransferReceiptKind;
disposition: App.Modules.Inventory.Domain.Enums.TransferCloseDisposition;
close_reason: App.Modules.Inventory.Domain.Enums.TransferDiscrepancyReason;
close_note: string | null;
sequence: number;
status: App.Modules.Inventory.Domain.Enums.TransferReceiptStatus;
is_blind: boolean;
...
notes: string | null;
freight_uncapitalized: string;
lines: Array<App.Modules.Inventory.Application.DTOs.TransferCloseLineData>;
};
export type TransferReconciliationData = {
transfer_id: string;
transfer_number: string;
status: App.Modules.Inventory.Domain.Enums.TransferStatus;
source_location_id: string;
...
close_reason: App.Modules.Inventory.Domain.Enums.TransferDiscrepancyReason | null;
close_note: string | null;
lines: Array<App.Modules.Inventory.Application.DTOs.TransferReconciliationLineData>;
receipts: Array<App.Modules.Inventory.Application.DTOs.TransferReconciliationReceiptData>;
summary: App.Modules.Inventory.Application.DTOs.TransferReconciliationSummaryData;
};
export type TransferReconciliationLineData = {
transfer_line_id: string;
product_id: string;
product_name: string;
product_sku: string;
...
remaining: string;
variance: string;
discrepancy_reasons: Array<App.Modules.Inventory.Domain.Enums.TransferDiscrepancyReason>;
lots: Array<App.Modules.Inventory.Application.DTOs.TransferReconciliationLotData>;
};
export type TransferReconciliationLotData = {
batch_id: string;
batch_number: string;
expiry_date: string | null;
sent: string;
...
export type TransferReconciliationReceiptData = {
receipt_number: string;
kind: App.Modules.Inventory.Domain.Enums.TransferReceiptKind;
disposition: App.Modules.Inventory.Domain.Enums.TransferCloseDisposition | null;
sequence: number;
received_by: { id: string; name: string };
received_at: string;
is_blind: boolean;
...
export type MovementGlCounterFamily = 'neither' | 'cogs' | 'shrinkage' | 'directional_variance';
...
export type TransferActorRole = 'receiver' | 'closer';
export type TransferCloseDisposition = 'write_off' | 'return_to_source';
export type TransferCostDistribution = 'pro_rata_value' | 'pro_rata_quantity' | 'equal_per_line';
export type TransferDiscrepancyReason = 'short_shipped' | 'lost_in_transit' | 'damaged_in_transit' | 'other';
export type TransferReceiptFailureReason = 'OVER_RECEIPT' | 'LOT_OVER_RECEIPT' | 'UNKNOWN_LOT' | 'LOT_REQUIRED' | 'LOT_NOT_ALLOWED' | 'LOT_SUM_MISMATCH' | 'LOT_TRACKING_MISMATCH' | 'LINE_NOT_ON_TRANSFER' | 'NOTHING_TO_RECEIVE' | 'DISCREPANCY_REASON_REQUIRED' | 'DISCREPANCY_REASON_INVALID' | 'IDEMPOTENCY_KEY_REUSED' | 'DISPOSITION_REQUIRED' | 'BLIND_REQUIRES_COUNTED_RECEIPT' | 'GL_ACCOUNTS_UNMAPPED' | 'VALUATION_MODE_UNSUPPORTED';
export type TransferReceiptKind = 'receipt' | 'close' | 'legacy_completion';
export type TransferReceiptStatus = 'posted';
export type TransferStatus = 'draft' | 'in_transit' | 'partially_received' | 'completed' | 'closed_with_writeoff' | 'closed_returned' | 'cancelled';
...
lines: Array<App.Modules.POS.Application.DTOs.ReceiptDetailLineData>;
vat_details: Array<App.Modules.POS.Application.DTOs.ReceiptDetailVatData>;
payments: Array<App.Modules.POS.Application.DTOs.ReceiptDetailPaymentData>;
return_receipts: Array<App.Modules.POS.Application.DTOs.ReceiptReturnLineageData>;
original_receipt_id: string | null;
original_receipt: App.Modules.POS.Application.DTOs.ReceiptOriginalLineageData | null;
};
export type ReceiptDetailLineData = {
id: string;
line_number: number;
product_id: string | null;
product_name: string;
...
export type ReceiptDetailPaymentData = {
id: string;
...
export type ReceiptDetailVatData = {
tax_rate: string;
net_amount: string;
vat_amount: string;
gross_amount: string;
...
export type ReceiptOriginalLineageData = {
id: string;
receipt_number: string;
posted_at: string;
total: string;
...
export type ReceiptReturnLineageData = {
id: string;
receipt_number: string;
posted_at: string;
invoice_type_code: string;
...
refund_reason_source: string;
refund_destination: string | null;
};
export type RefundReportingData = {
...
export type StockMovementReferenceType = 'Document' | 'inventory_counting' | 'pos_receipt_return_scrap' | 'stock_adjustment' | 'supplier_goods_return_note' | 'batch_ledger_repair' | 'stock_transfer_receipt';
