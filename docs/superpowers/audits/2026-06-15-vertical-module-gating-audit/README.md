...
1. Add `RequireModule` gates to the 9 ungated vertical-exclusive module route groups (HIGH-A); add a CI/test guard that fails when a vertical-exclusive route lacks a module gate.
