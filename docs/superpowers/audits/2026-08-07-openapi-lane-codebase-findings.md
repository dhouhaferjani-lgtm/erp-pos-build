...
## F-7 — BatchExpiry FEFO suggestion pipeline runs quantities on native floats end-to-end (precision-contract violation, POS-serving endpoint) ⚠️ HIGHEST PRIORITY
