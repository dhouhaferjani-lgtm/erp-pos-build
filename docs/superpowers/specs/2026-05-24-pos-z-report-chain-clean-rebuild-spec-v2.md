# POS Z-Report Chain Clean Rebuild Spec (v2)
...
**Recommendation locked in v2 unless owner overrides:** Z-report/session chain owns cash drawer movement fiscal events.
