...
**Date:** 2026-07-13
**Status:** Rev 2 — reconciles the 4-lane adversarial review (`docs/superpowers/specs/reviews/2026-07-13-treasury-phase4-expense-depth-spec-review.md`; all lanes APPROVE-WITH-FIXES, every accepted disposition folded in). Ready for writing-plans.
