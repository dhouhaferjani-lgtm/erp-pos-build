...
2. **Media & Files section = DEFERRED entirely** (avoid colliding with in-flight media-subsystem-unification). Editor ships without it; added after that work merges.
