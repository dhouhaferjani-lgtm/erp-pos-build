...
- ⛔ **Accounting gate:** §4.1 chart codes (`403`/`4035`) are provisional. **Build may proceed on provisional codes; NOTHING merges to dev until the expert-comptable confirms them** (spec §10 wording aligned to this).
