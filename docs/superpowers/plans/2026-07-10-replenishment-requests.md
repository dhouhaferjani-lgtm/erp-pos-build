...
- `documents`/`document_lines` money columns are `decimal(15,2)` (pre-existing); do NOT "fix" the columns — compute per rule 19 and store what the columns hold.
