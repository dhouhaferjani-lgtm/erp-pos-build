...
## D. Session G / H lane retests — **APPLY: 12 (G-3b), 15 (G-3c), 16 (H cleanup) — batch 1a, in build `0e5d28705`. 13 (G-6a) PENDING batch 2 overnight — do it only if Session J confirms; 14 (G-4) SKIP.**
