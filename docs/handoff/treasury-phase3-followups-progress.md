...
| F-2 | Complete | `8b3fad0c6` + this final-review fix | Focused Vitest: 2 files, 16 tests passed; focused ESLint: 0 errors; React Doctor: 98/100, no issues found | Eligible active, non-virtual repositories expose the permission-gated detail action and open the existing modal with a changeable, preselected source. |
...
- Changed Treasury UI verification after the final rebase: 3 files, 19 tests passed.
