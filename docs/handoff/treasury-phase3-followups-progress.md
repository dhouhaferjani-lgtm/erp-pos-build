...
| F-2 | Complete | `8b3fad0c6` | Focused Vitest: 2 files, 13 tests passed; focused ESLint: 0 errors; React Doctor: 98/100, no issues found | Permission-gated detail action opens the existing modal with a changeable, preselected source repository. |
