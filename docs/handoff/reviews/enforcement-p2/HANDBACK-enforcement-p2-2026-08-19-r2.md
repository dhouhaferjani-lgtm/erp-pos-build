...
| **final SHA (A′)** | `cabd15e5108b93d36b445d73aeddbb2a18c55641` |
| **commits** | 57 |
...
Commit list: `git log --oneline c97e0d1ad..HEAD` (57 entries; the milestone-closing ones are
`5.0.1` M0, `5.1.19` M1 ACCEPT, `5.2.19` M2 ACCEPT, `5.3.14` M3 ACCEPT, `5.4.1` M4 evidence, `5.4.2` M4 status: review, `5.4.3` final-gate fix round 1, `5.4.4` M4 bookkeeping).
...
```
HEAD-EQUALITY CHECK
  claimed A′         = cabd15e5108b93d36b445d73aeddbb2a18c55641
  git rev-parse HEAD = cabd15e5108b93d36b445d73aeddbb2a18c55641
  MATCH ✓ — the proof is being run at the SHA it claims

$ git diff --stat c97e0d1ad..HEAD | tail -1
 84 files changed, 12059 insertions(+), 44 deletions(-)
