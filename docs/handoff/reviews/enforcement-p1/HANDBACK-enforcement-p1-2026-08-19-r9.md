...
| Final SHA | `2a9888db8967bd2ebda61e20addae30ee74716d9` — the handover tip after the owner-raised authority was mirrored (the handback itself is untracked by contract) |
...
**Re-derived VERBATIM at `2a9888db8967bd2ebda61e20addae30ee74716d9` against the NEW base `67d18746a`**, after this round's last tracked commit.

```
$ git rev-parse HEAD
2a9888db8967bd2ebda61e20addae30ee74716d9
...
$ git diff --stat 67d18746a5e1c565c1f33c0394ae518af0e1cbf0..HEAD
 ...
 docs/handoff/progress/enforcement-p1.progress.yaml |  141 +-
 15 files changed, 4851 insertions(+), 26 deletions(-)
...
| 3 — §6.3's line anchors were pre-fix-commit with no commit pin | §6.3 now states the pastes were produced at the pins commit `de067d50b` and to check assertion COUNTS, not `:NNN` anchors |
