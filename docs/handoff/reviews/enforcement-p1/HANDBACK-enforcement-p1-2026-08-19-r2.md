...
| Final SHA | `fbdc4e99210fd4390b45be86a8b3c39bf355f340` — the handover tip A′ after final-gate fix round 1 (the handback itself is untracked by contract) |
...
| M3 | final gate round 1 → CHANGES-REQUIRED (documentation-only); fix round 1 applied; re-handed over | PARENT-invoked |
